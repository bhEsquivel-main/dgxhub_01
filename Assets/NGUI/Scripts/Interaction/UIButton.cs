...
public class UIButton : UIButtonColor
{
    ...
    public UILabel EnabledLabel = null;
    public Color EnabelColor = new Color(140.0f / 255.0f, 140.0f / 255.0f, 140.0f / 255.0f, 1.0f);
    Color BeforeColor;
			...
			if (isEnabled != value)
			{
				...
				if (col != null)
				{
                    ...
                    if (EnabledLabel != null)
                    {
                        if (!value)
                        {
                            BeforeColor = EnabledLabel.color;
                            EnabledLabel.color = EnabelColor;
                        }
                        else
                        {
                            EnabledLabel.color = BeforeColor;
                        }
                    }
