...
public class UIButtonEditor : UIButtonColorEditor
{
	...
	protected override void DrawProperties ()
	{
		...
		if (btn.tweenTarget != null)
		{
            ...
            btn.EnabledLabel = (UILabel)EditorGUILayout.ObjectField("EnabledLabel", btn.EnabledLabel, typeof(UILabel));
            btn.EnabelColor = EditorGUILayout.ColorField("Enabel Color", btn.EnabelColor); ;
		}
